<?php
	...
	*/
	 ...
	 */
		...
		$InternationalData		=  new ItemTypeData();
		
		
		
		$fieldArr = array("*");	
		$DataUser=$ObjInternationalMaster->getItemType($fieldArr,null,null,$from,$to); // Fetch Data
...
<head>
<title><?php echo ADMIN_HEADER_ITEM_LIST; ?></title>
					...
					<td valign="top">
						<table border="0" width="100%" cellpadding="0" cellspacing="0"  align="center" class="middle_right_content">
							<tr>
								...
								<div><label class="top_navigation"><a onclick="mtrash('<?php echo FILE_ITEM_TYPE_ACTION;?>','<?php echo ADMIN_USERS_DELETE_CONFIRM; ?>');"><?php echo COMMAN_DELETE; ?></a>
								<label class="top_navigation"><a href="<?php echo FILE_ITEM_TYPE_ACTION; ?>"><?php echo ADMIN_POSTCODE_ADD_NEW ; ?></a>
								<a href="<?php echo FILE_ITEM_TYPE_ACTION; ?>?Action=export_international_zone_csv"><?php echo ADMIN_POSTCODE_EXPORT_NEW ; ?></a>
								</label>
							...
							<tr>
								<td class="heading">
								<?php echo ADMIN_HEADER_ITEM_LIST; ?>
								</td>
							</tr>
							<?php if($message!='') {?>
							<tr>
										...
										<table width="100%" cellspacing="0" cellpadding="0" class="display" id="maintable">
											<thead>
												<tr>
													...
													<th width="15%" align="center"><?php echo ADMIN_SERVICE_PAGE_TYPE; ?></th>
													
													<th width="8%" align="center"><?php echo ADMIN_DAYS; ?></th>
													<th width="2%" align="center"><?php echo ADMIN_SERVICE_SORTING_NUMBER; ?></th>
											...
											<tbody>
												...
												<td align="center"> <input type="checkbox" name="m_trash" id="<?php echo $users_details['item_id'];?>"></td>
													<td align="center"><?php echo $i = 1 +$from;?></td>
													<td><?php echo valid_output($users_details['item_name']); ?></td>
													
													<td><?php echo valid_output($users_details['type']);?></td>
													<td><?php echo valid_output($users_details['sorting']);?></td>
													<td align="center" nowrap="nowrap">
														<a href="<?php echo FILE_ITEM_TYPE_ACTION; ?>?Action=edit&amp;item_id=<?php echo $users_details['item_id'];?>"><?php echo COMMON_EDIT; ?></a> | 
														<a href="<?php echo FILE_ITEM_TYPE_ACTION; ?>?Action=trash&amp;item_id=<?php echo $users_details['item_id'].$URLParameters; ?>" onclick="return confirm('<?php echo ADMIN_USERS_DELETE_CONFIRM; ?>')"><?php echo COMMAN_DELETE; ?></a>												
													</td>
											...
											<tfoot>
												<tr>
													...
													<th align="center"><?php echo ADMIN_SERVICE_PAGE_TYPE; ?>&nbsp;</th>
													
													<th align="center"><?php echo ADMIN_DAYS; ?>&nbsp;</th>
													<th align="center"><?php echo ADMIN_SERVICE_SORTING_NUMBER; ?>&nbsp;</th>
