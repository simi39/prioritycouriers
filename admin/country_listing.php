...
$DataUser=$ObjCountryMaster->getCountry($fieldArr, null,null,$from,$to, true, true);

?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><?php echo ADMIN_HEADER_COUNTRY;?></title>
					...
					<td valign="top">
						<table border="0" width="100%" cellpadding="0" cellspacing="0"  align="center" class="middle_right_content">
							<tr>
								...
								<span><a href="<?php echo FILE_WELCOME_ADMIN; ?>"><?php echo ADMIN_HEADER_HOME;?></a> > <?php echo ADMIN_HEADER_COUNTRY; ?></span>
								<div><label class="top_navigation"><a onclick="mtrash('<?php echo FILE_COUNTRY_ACTION;?>','<?php echo ADMIN_USERS_DELETE_CONFIRM; ?>');"><?php echo COMMAN_DELETE; ?></a>
								<label class="top_navigation"><a href="<?php echo FILE_COUNTRY_ACTION; ?>"><?php echo ADMIN_ADD_NEW ; ?></a>
								<a href="<?php echo FILE_COUNTRY_ACTION; ?>?Action=export"><?php echo ADMIN_EXPORT_NEW ; ?></a></label>
										...
										<table width="100%" cellspacing="0" cellpadding="0" class="display" id="maintable">
											<thead>
												<tr>
													...
													<th width="15%" align="center"><?php echo COUNTRY_NAME; ?></th>
													<th width="20%" align="center"><?php echo ISOCODE2; ?></th>		
													<th width="10%" align="center" ><?php echo ZONE; ?></th>
													<th width="10%" align="center" ><?php echo DAYS; ?></th>
													<th width="10%" align="center" ><?php echo AREA_CODE; ?></th>			
													<th width="10%" align="center" ><?php echo STATUS; ?></th>		
											...
											<tbody>
												...
												<tr class="<?php echo $rowClass; ?>">
											    	<td align="center"> <input type="checkbox" name="m_trash" id="<?php echo $users_details['countries_id'];?>"></td>
													<td align="center"><?php echo $i = 1 +$from;?></td>
													<td><?php echo valid_output($users_details['countries_name']); ?></td>
													<td><?php echo valid_output($users_details['countries_iso_code_2']);?></td>
													<td><?php echo valid_output($users_details['zone']);?></td>
													<td><?php echo valid_output($users_details['days']);?></td>
													<td><?php echo valid_output($users_details['area_code']);?></td>
													<td><?php echo valid_output($users_details['status']);?></td>
													
													
													<td align="center" nowrap="nowrap">
														<a href="<?php echo FILE_COUNTRY_ACTION; ?>?Action=edit&amp;countries_id=<?php echo $users_details['countries_id'];?>"><?php echo COMMON_EDIT; ?></a> | <a href="<?php echo FILE_COUNTRY_ACTION; ?>?Action=trash&amp;countries_id=<?php echo $users_details['countries_id'].$URLParameters; ?>" onclick="return confirm('<?php echo ADMIN_USERS_DELETE_CONFIRM; ?>')"><?php echo COMMAN_DELETE; ?></a>
											...
											<tfoot>
												<tr>
													...
													<th align="center"><?php echo COUNTRY_NAME; ?>&nbsp;</th>
													<th align="center"><?php echo ISOCODE2; ?>&nbsp;</th>
													<th align="center"><?php echo ZONE; ?>&nbsp;</th>
													<th align="center"><?php echo DAYS; ?>&nbsp;</th>
													<th align="center"><?php echo AREA_CODE; ?>&nbsp;</th>
