<?php
	...
	*/
	...
	$DataUser=$objQuoteCustomerMaster->getQuoteCustomerDetailsAddress($fieldArr, null,null,$from,$to, true, true);
					...
					<td valign="top">
						<table border="0" width="100%" cellpadding="0" cellspacing="0"  align="center" class="middle_right_content">
							<tr>
								...
								<div><label class="top_navigation"><a onclick="mtrash('<?php echo  FILE_QUOTE_CUSTOMER_DETAILS_ITEMS_ACTION;?>','<?php echo ADMIN_USERS_DELETE_CONFIRM; ?>');"><?php echo COMMAN_DELETE; ?></a>
								<label class="top_navigation"><a href="<?php echo FILE_QUOTE_CUSTOMER_DETAILS_ITEMS_ACTION; ?>"><?php echo ADMIN_ADD_NEW ; ?></a>
										...
										<table width="100%" cellspacing="0" cellpadding="0" class="display" id="maintable">
											<thead>
												...
												<th width="5%" align="center"> <input type="checkbox" name="m_trash_main" id="m_trash_all" > </th>
													...
													<th width="10%" align="center" ><?php echo ACCOUNT_NUMBER; ?></th>		
											...
											<tbody>
												...
												<td align="center"> <p id="checkBoxes"><input type="checkbox" class="checkBoxClass" name="m_trash" id="<?php echo $users_details['id'];?>"></p></td>
													<td align="center"><?php echo $i = 1 +$from;?></td>
													
													<td><?php echo valid_output($users_details['last_name'])."&nbsp;&nbsp;".valid_output($users_details['first_name']); ?></td>
													<td><?php echo valid_output($users_details['account_number']);?></td>
													...
													<td align="center" nowrap="nowrap">
														<a href="<?php echo FILE_QUOTE_CUSTOMER_DETAILS_ITEMS_ACTION; ?>?Action=edit&amp;addressId=<?php echo $users_details['id'];?>"><?php echo COMMON_EDIT; ?></a> | <a href="<?php echo FILE_QUOTE_CUSTOMER_DETAILS_ITEMS_ACTION; ?>?Action=trash&amp;addressId=<?php echo $users_details['id'].$URLParameters; ?>" onclick="return confirm('<?php echo ADMIN_USERS_DELETE_CONFIRM; ?>')"><?php echo COMMAN_DELETE; ?></a>
													</td>
											...
											<tfoot>
												...
												<th align="center"><?php echo ADMIN_COMMON_SERIAL_NO; ?>&nbsp;</th>
													...
													<th align="center"><?php echo ACCOUNT_NUMBER; ?>&nbsp;</th>
