...
/**
 * Add Google Maps API for gmaps.js.
 */
function add_custom() {
  wp_enqueue_script( 'gmap','http://maps.google.com/maps/api/js?sensor=true');   
}
...
function dazzling_scripts() {
  ...
  wp_enqueue_style( 'custom-style-unity', get_template_directory_uri() . '/inc/css/unity/custom-style.css' );
  
  wp_enqueue_style( 'header-unity', get_template_directory_uri() . '/inc/css/unity/header.css' );
  
  wp_enqueue_style( 'style-responsive-unity', get_template_directory_uri() . '/inc/css/unity/style_responsive.css' );
  ...
  wp_enqueue_script('custom', get_template_directory_uri().'/inc/js/jquery.min.js', array('jquery') );
  wp_enqueue_script('customsd', get_template_directory_uri().'/inc/js/app.js', array('jquery') );
  
  
 

  wp_enqueue_script('dazzling-bootstrapjs', get_template_directory_uri().'/inc/js/bootstrap.min.js', array('jquery') );
  wp_enqueue_script('dazzling', get_template_directory_uri().'/inc/js/bootstrapValidator.min.js', array('jquery') );
  ...
  //jquery.min.js
  wp_enqueue_script( 'flexslider', get_template_directory_uri() . '/inc/js/flexslider.min.js', array('jquery'), '2.2.2', true );
  wp_enqueue_script('dazzling-main', get_template_directory_uri().'/inc/js/gmaps.js', array('jquery') );
  wp_enqueue_script('test', get_template_directory_uri().'/inc/js/tracking.js', array('jquery') );
