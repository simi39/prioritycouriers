<?php
/**
 * This is ForgotPassIPAddressData model file.
 * Create interaction between ForgotPassIPAddressMaster (business logic) and forgotpass_ipaddress_attempts table by mapping all fields.
 * PropertyMap method return array which has similar elements of forgotpass_ipaddress_attempts table fields and used in controller file.
 * 
 * TABLE_NAME: forgotpass_ipaddress_attempts
 * LICENSE:    License Information (if any) ...
 * 
 * @uses Create interface between forgotpass_ipaddress_attempts table and ForgotPassIPAddressMaster (business logic) files.
 * 
 * @package    ForgotPassIPAddress Management
...
class ForgotPassIPAddressData extends RDataModel
{
   /**
