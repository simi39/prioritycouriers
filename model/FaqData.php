...
class FaqData extends RDataModel
{		
   /**
    ...
    */	
    protected function PropertyMap() 
    {
		...
		$PropMap['faq_id'] 	 		= array('Field', 'faq_id', 'faq_id', 'int');
		...
		$PropMap['faq_question'] 	= array('Field', 'faq_question', 'faq_question', 'string');
		$PropMap['faq_answer']		= array('Field', 'faq_answer', 'faq_answer', 'string');
