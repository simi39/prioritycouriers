...
$arr_javascript_below_include[] = 'internal/interstate.php';
//$arr_javascript_below_include[] = 'internal/differenceHours.js';
...
{
	$err['pickup'] = chkStr($_POST['pickup']);
}
if(!empty($total_amt))
{
...
echo "</pre>";*/
$fieldArr =array();
$fieldArr=array("service_name","service_description","box_color","hours","minites","hr_formate");
$seaByArr=array();
...
$seaByArr[]=array('Search_On'=>'supplier_id', 'Search_Value'=>"0", 'Type'=>'int', 'Equation'=>'=', 'CondType'=>'', 'Prefix'=>'and', 'Postfix'=>'');
...
if (isset($bk_type_hidden) && $bk_type_hidden!="" && $Svalidation == false) {
	...
	$BookingDetailsDataObjArray["servicepagename"] = "overnight";
	if(isset($_POST['interstate_collection_date']) && $_POST['interstate_collection_date']!=""){
		$start_date = $_POST['interstate_collection_date']; 
	}
	...
	$seaByArr=array();
	///echo "courier id:".$courier_id_hidden;
	...
	//echo "courier_name:".$courier_name;
	//exit();
