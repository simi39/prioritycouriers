 ...
 *
 * @version $Id: RReadOnlyPropertyException.php,v 1.1 2008-07-04 13:51:27 nitin Exp $ 
 *
 * Revision Histry:-
 * $Log: RReadOnlyPropertyException.php,v $
 ...
 */
class RReadOnlyPropertyException extends Exception
{
	function __construct($Error = null)
	{
		if (is_string($Error)) {
			...
			parent::__construct("Read Only Property");
		}
	}
}
?>