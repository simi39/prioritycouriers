 ...
 *
 * @version $Id: REventNotFoundException.php,v 1.1 2008-07-04 13:51:26 nitin Exp $ 
 *
 * Revision Histry:-
 * $Log: REventNotFoundException.php,v $
 ...
 */
class REventNotFoundException extends Exception
{
	function __construct($Class)
	{
		parent::__construct("Event not found in '$Class'");
	}
}
?>