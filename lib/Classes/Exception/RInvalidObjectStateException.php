 ...
 *
 * @version $Id: RInvalidObjectStateException.php,v 1.1 2008-07-04 13:51:26 nitin Exp $ 
 *
 * Revision Histry:-
 * $Log: RInvalidObjectStateException.php,v $
 ...
 * rfile exception
 */
class RInvalidObjectStateException extends Exception
{
