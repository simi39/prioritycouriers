 ...
 *
 * @version $Id: RRFormRequiredException.php,v 1.1 2008-07-04 13:51:26 nitin Exp $ 
 *
 * Revision Histry:-
 * $Log: RRFormRequiredException.php,v $
 ...
 * rsite exception
 */
class RRFormRequiredException extends Exception
{
	function __construct($Message)
	{
		parent::__construct('RForm is required, '.$Message);
	}
}
?>