...
// +----------------------------------------------------------------------+
//
// $Id: pearcmd.php,v 1.1 2008-07-04 13:51:27 nitin Exp $
 ...
 * @nodep Gtk
 */
if ('C:\wamp\php\PEAR\pear' != '@'.'include_path'.'@') {
    ini_set('include_path', 'C:\wamp\php\PEAR\pear');
    $raw = false;
} else {
