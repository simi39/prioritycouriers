...
define("COMMON_SELECT_TIME","Select Time");
define("COMMON_SELECT_DATE","Select Date");
define("SELECT_SERVICE","Select Service");
define("BOOKING_HEADER_MSG","Prioritycouriers Says:");
define("SEL_BOOKING_MSG","Please click on any SELECT SERVICE button to go further.");
define("BOOKING_CONFIRMATION_MSG","Are you sure you want to proceed further?");
?>
